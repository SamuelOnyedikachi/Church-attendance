...
const AttendanceChart = ({
  ...
  data: { date: string; total: number; male: number; female: number }[];
}) => {
  ...
  const makePath = (key: 'total' | 'male' | 'female') =>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full md:w-auto bg-black text-white px-6 py-2 rounded-md hover:bg-gray-800 transition-colors"
            >
              Create
            </button>
          </form>
